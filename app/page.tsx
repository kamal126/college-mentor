  ...
  return (
    <div className="min-h-screen flex flex-col w-full">
                    ...
                    <div className="w-2/3 bg-primary/5 rounded-md p-4 flex flex-col gap-2">
                      {Array(6)
                        ...
                        .map((_, i) => (
                          <div
                            key={i}
                            className={`h-4 ${i === 0 ? "h-6 w-3/4" : i === 4 ? "w-full" : i === 5 ? "w-4/5" : i === 3 ? "w-5/6" : "w-full"} bg-primary/10 rounded-md`}
                          />
                        ))}
                    </div>
                    <Image
        ...
        <div className="container px-4 md:px-6 max-w-7xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
            {features.map((feature, idx) => (
              <Card
                key={idx}
                className="bg-card/50 backdrop-blur-sm border-primary/10 overflow-hidden group hover:shadow-md transition-all duration-300 relative"
              >
                ...
                <CardHeader className="pb-2">
                  ...
                  <CardDescription>{feature.descption}</CardDescription>
                </CardHeader>
                <CardContent>
      ...
      <section className="w-full py-24 relative overflow-hidden">
        <div className="absolute -bottom-60 left-1/2 -translate-x-1/2 lg:w-2/3 h-t2 bg-primary/20 rounded-full blur-[300px]" />
        <div className="container max-w-7xl mx-auto px-4 md:px-6 flex flex-col items-center text-center">
          <h2 className="text-3xl md:text-6xl font-bold mb-6 max-w-3xl">
