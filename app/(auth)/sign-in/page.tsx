    ...
    <div className="min-h-screen flex items-center bg-[#F5F8FF] px-8">
      ...
      <div className="w-1/2 space-y-6 pl-10">
        ...
        <div className="space-y-4 pt-4">
          <Feature icon={<Star />} title="AI-Powered Guidance" description="Get instant answers 24/7" />
          <Feature icon={<List />} title="Personalized Resources" description="Tailored to your profile" />
          <Feature icon={<Shield />} title="Secure & Private" description="Your data is encrypted" />
        </div>
      </div>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input type="email" placeholder="kamal@example.com" className="pl-9" />
              </div>
            </div>
